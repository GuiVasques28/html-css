...
if (typeof usi_js === 'undefined') {
	usi_js = {
		campaign: {
			id: '7995823730301646716801',
			site_id: 56039,
			original_site_id: 56039,
			config_id: 133183,
			company_id: 5698,
			key: 'desktop_portuguese',
			link: 'https://shutterstock.7eer.net/c/16669/42913/1305',
			deep_link: 'https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=Premium&url=',
			domains: '',
			backtrap_urls: '',
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-6-2025-dsktp-premiumcontent-blank-3x.webp",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
			...
			css: ".usi_display * {  font-size: 1em;  line-height: 1.2;  box-sizing: border-box;  color: inherit;  font-family: Roboto, Arial;}.usi_display {  color: #000;  font-family: Roboto, Arial;}.usi_header_text {\tposition: absolute;  top: 21%;  left: 6%;  width: 48%;  font-size: 1.2em;\ttext-align: left;  color: #000;  letter-spacing: -1px;}.usi_text_bottom {  position: absolute;  top: 32%;  left: 6%;  width: 50%;  font-size: 2.3em;  color: #000;  letter-spacing: -1px;  font-weight: bold;  text-align: left;}/* Submit Button */.usi_submitbutton:hover, .usi_submitbutton:active, .usi_submitbutton:focus {  background: none;  border: none;}.usi_submitbutton {  position: absolute;\ttop: 72.5%;  left: 5.5%;  width: 32%;  height: 12.5%;  display: inline-block;  background: none;  border: none;  margin: 0;  padding: 0;  cursor: pointer;  text-align: center;  color: #fff;  font-weight: bold;  font-size: 1.4em;}.usi_disclaimer {\tposition: absolute;\ttop: 93%;  left: 6%;  text-align: left;  width: 55%;  font-size: 0.75em;  color: #000 !important;  text-decoration: underline;}  ",
			focus_trap: 0
		},
		timers: {
			display_timer: -1,
...
usi_js.click_cta = function(){
    ...
    // https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=Premium&url=
    // usi_commons.load_script('https://app.upsellit.com/utility/impact_link.jsp?id=XXXXX&url='+encodeURIComponent(usi_js.campaign.link), function() { });
  } else {   	 
    usi_js.deep_link();    
  }
};
...
var css_override = usi_app.messaging.css ? usi_app.messaging.css : "";
if(css_override) {
  // Some langs need adjustment to fit the modal
	var el = document.createElement('style');
  el.id = 'usi_premiumbeat_additional_css';
  el.type = "text/css";
  el.innerText = css_override;
...
usi_js.display_vars.p1_html = [
  ...
  '<a class="usi_disclaimer" href="https://labs.upsellit.com/privacy-policy" target="_blank">',usi_app.messaging.disclaimer,'</a>'
].join('');
		...
		scroll_monitor: function(do_launch) {
			try {
				if (typeof(usi_js) === "undefined") return;
				var doc = usi_js.scrolling_element != null ? usi_js.scrolling_element : document.body;
