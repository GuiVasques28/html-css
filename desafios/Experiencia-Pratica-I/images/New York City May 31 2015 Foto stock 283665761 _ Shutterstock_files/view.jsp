...
if (typeof usi_js === 'undefined') {
	usi_js = {
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/2025-06-rebrand-dsktp-pre-blank.webp",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
...
if(usi_app.is_enabled && usi_js.campaign.original_site_id == "59637") { 
...
usi_js.click_cta = function(){
	usi_js.set_coupon();
	if (1==0 && location.href.indexOf("/purchase") != -1) {
